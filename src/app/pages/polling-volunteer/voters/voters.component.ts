...
export class VotersComponent implements OnInit {
  ...
  constructor( private authService: AuthService, 
                private pollingVolunteerService: PollingVolunteerServiceService,        
    ) { 
  ...
  ngOnInit(): void {
    ...
    this.pollingVolunteerService.getVotersByPollingVolunteerId(this.loggedInUser?.uniqueId).subscribe((response: { status: string, message: string, data: any[] }) => {
